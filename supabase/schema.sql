-- Supabase Schema for Dual-Track Planner
...
CREATE TABLE IF NOT EXISTS tasks (
    ...
    dead TEXT NOT NULL, -- 'today', '2', '4', '7', '14'
    "window" TEXT DEFAULT '', -- Double quotes applied to handle reserved word
...
-- Helper: users can only access their own data
-- PROFILES
